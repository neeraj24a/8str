 ...
 *
 * Modified by CGI-Central
 *  1. autoload jQuery
 *  2. wrap image with <a>, using rev attribute as href
 */
...
if (typeof jQuery == "undefined") {
    ...
    scriptObj.onload = amInitLightbox;
		...
		function _set_image_to_view() { // show the loading
			...
			objImagePreloader.onload = function() {
				$('#lightbox-image').attr('src',settings.imageArray[settings.activeImage][0]).
                                    wrap($('<a></a>').attr('href', settings.imageArray[settings.activeImage][2]));
		...
		function _show_image_data() {
			...
			if ( settings.imageArray[settings.activeImage][1] ) {
				$('#lightbox-image-details-caption').html(
                                    $('<a></a>').attr('href', settings.imageArray[settings.activeImage][2]).
                                        append(settings.imageArray[settings.activeImage][1])
                                ).show();
			}
