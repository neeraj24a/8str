...
class Am_Paysystem_AmazonPay extends Am_Paysystem_CreditCard
{
    ...
    {
        $form->addText('merchant-id', 'class="am-el-wide"')
            ->setLabel('Your Merchant ID');

        $form->addText('client-id', 'class="am-el-wide"')
            ->setLabel('Client ID');

        $form->addSecretText('client-secret', 'class="am-el-wide"')
            ->setLabel('Secret Access Key');

        $form->addText('access-id', 'class="am-el-wide"')
            ->setLabel('Access Id');
...
class Am_Mvc_Controller_CreditCard_AmazonPay extends Am_Mvc_Controller
{
    ...
    function createForm($label, $cc_mask = null)
    {
        ...
        $form->addStatic('amazon-payment-form', array('class' => 'am-no-label'))
            ->setContent(<<<EOT
