jQuery(document).ready(function(){
    ...
    jQuery('#admin-login').submit(function(){
        ...
        jQuery.ajax({
            ...
            data: jQuery('#admin-login input').serializeArray(),
            complete: function (response)
            {
                ...
                if (data.ok)
                {
                    ...
                    jQuery("#admin-login .errors li").text(data.err);
                    jQuery("#admin-login .errors").show();
                }
            }
        });
...
jQuery(document).tooltip({
    ...
    content: function(callback) {
        if ($(this).data('tooltip-url')) {
            if ($(this).data('tooltip')) {
                return $(this).data('tooltip');
            }
            var that = this;
            jQuery.get($(this).data('tooltip-url'), function(html) {
                $(that).data('tooltip', html);
                callback(html);
            });
        } else {
            return $(this).data('tooltip');
