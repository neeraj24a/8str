...
class Zend_Controller_Request_Http extends Zend_Controller_Request_Abstract
{
    ...
    public function getHttpHost()
    {
        ...
        // patched by alex@cgi-central.net - handle case when HTTP site is behing SSL CF, avoid links https://xxx:80/
        elseif (($scheme == self::SCHEME_HTTP && $port == 80) || ($scheme == self::SCHEME_HTTPS && (($port == 443) || ($port == 80)))) {
            return $name;
        } else {
            return $name . ':' . $port;
        }
