...
CUT;
    ...
    function _initSetupForm(Am_Form_Setup $form)
    {
        ...
        $form->addText('redirect_url', array('class' => 'am-el-wide', 'placeholder' => ROOT_URL))
        ...
        $form->addText('page_title', array('class' => 'am-el-wide'))
...
CUT
    ...
    function directAction(Am_Mvc_Request $request, Am_Mvc_Response $response, array $invokeArgs)
    {
        ...
        foreach ($documents as $agreement)
        {
            ...
            {
                $el = $form->addStatic($agreement->type, array('class' => 'am-no-label'));
