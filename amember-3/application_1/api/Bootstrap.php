...
useful if something is going wrong', '<a href="'.$url.'">', '</a>'));
    ...
    protected function addDefaultControllers()
    {
        ...
        $this->addController('product-product-category', 'product-product-category', array('index'), 'Relations Between Products and Categories', 'api');
        ...
        $this->addController('check-access', 'check-access', array('by-login-pass', 'by-login', 'by-email', 'by-login-pass-ip'),
