...
class Am_Paysystem_Xfers extends Am_Paysystem_Abstract
{
    ...
    public function _initSetupForm(Am_Form_Setup $form)
    {
        ...
        $form->addText("api_key", array('class' => 'el-wide api_v2'))
            ->setLabel('Merchant API Key');
        $form->addPassword("api_secret", array('class' => 'el-wide api_v2'))
            ->setLabel('Merchant API Secret');

        $form->addText("api_key_v3", array('class' => 'el-wide api_v3'))
