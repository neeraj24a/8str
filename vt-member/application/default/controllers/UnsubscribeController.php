                ...
                foreach ($prefs as $k => $v)
                {
                    ...
                    switch ($v)
                    {
                        ...
                        case 'subscribe':
                            ...
                            $this->getDi()->userConsentTable->recordConsent($this->view->user, 'newsletter-list-' . $k, $this->getRequest()->getClientIp(), ___('Unsubscribe Page: %s', $this->getRequest()->getHeader('REFERER') ?: ___('Dashboard')), $list->title
                            );
