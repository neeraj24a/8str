...
//            Zend_Translate::setCache($cache);
 ...
 $domain = @$_SERVER['HTTP_HOST'];
    ...
    function initConstants()
    {
        ...
        $this->di->upload_dir_disk = DATA_DIR . '/upload';
        $this->di->public_dir = DATA_DIR . '/public';

        if (!defined('AM_VERSION'))
            define('AM_VERSION', '5.5.0');
        if (!defined('AM_BETA'))
            define('AM_BETA', '0' == 1);
...
class Am_View_Sprite
{
    protected static $_sprite_offsets = array (
        'icon' => array(
            ...
            'support' => 29260,
            'content-widget' => 29526,
            'gift-card' => 29792,
            'bundle-discount-adv' => 30058,
            'invite-history-all' => 30324,
            'earth' => 30590,
            'close' => 30856,
            'plus' => 31122,
            'email-snippet' => 31388,
            'repair-tables' => 31654,
            'content-category' => 31920,
            'buy-now' => 32186,
            'menu' => 32452,
            'content-loginreminder' => 32718,
            'schedule-terms-change' => 32984,
            'user-groups' => 33250,
            'xtream-codes-line' => 33516,
            'delete-requests' => 33782,
        ),
        'flag' => array(
            'ad' => 26,
            'ae' => 52,
