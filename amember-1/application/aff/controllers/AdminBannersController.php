...
class Am_Grid_Editable_Downloads extends Am_Grid_Editable
{
    ...
    public function createForm()
    {
        ...
        $form->addText('desc', array('class' => 'am-el-wide'))
...
abstract class Am_Grid_Editable_AffBannersAbstract extends Am_Grid_Editable
{
    ...
    function createForm()
    {
        ...
        $text = $form->addElement('text', 'title', array('class' => 'am-el-wide'))
                ->setLabel(___('Title'));
        $text->addRule('required');

        $url = $form->addElement('text', 'url', array('class' => 'am-el-wide'))
        ...
        $form->addElement('textarea', 'desc', array('rows' => 10, 'class' => 'am-el-wide'))
            ->setLabel(___('Description'));
...
class Am_Grid_Editable_Custom extends Am_Grid_Editable_AffBannersAbstract
{
    ...
    protected function _initForm($form)
    {
        $form->addTextarea('html', array('rows' => 10, 'class' => 'am-el-wide'))
...
class Aff_AdminGeneralLinkController extends Am_Mvc_Controller
{
    ...
    function createForm()
    {
        ...
        $form->addElement('text', 'general_link_url', array('class' => 'am-el-wide'))
