...
EOT;
    ...
    /**
     * @return string Affiliate Pogramm Model (default or last_click_wins)
     */
    ...
    function findAff()
    {
        $id = preg_replace('/[^. @a-zA-Z0-9_-]/', '', $this->getDi()->request->getParam('r', $this->getDi()->request->getParam('ref')));
        if (is_numeric($id)) {
