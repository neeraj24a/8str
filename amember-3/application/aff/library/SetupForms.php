...
class Am_Form_Setup_Aff extends Am_Form_Setup
{
    ...
    {
        $el = $this->addElement('select', 'aff.model', null, array('help-id' => '#Affiliate_Program_Model'))->setLabel('Affiliate Program Model');
        $el->loadOptions(
            array(
                Bootstrap_Aff::MODEL_DEFAULT =>___("Default"),
                Bootstrap_Aff::MODEL_LAST_CLICK_WINS => ___('Last Click Wins')
                )
            );
