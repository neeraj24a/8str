                                ...
                                <div class="one-whole">
                                    ...
                                    <div class="two-fifths pull-left">
                                        <div class="fieldset">
                                            <div class="field field--required">
                                                <div class="field__input-wrapper">
                                                    <?php echo $form->field($model, 'password', ['labelOptions' => [ 'class' => 'field__label field__label--visible' ]])->passwordInput(['class' => 'field__input', 'placeholder' => 'Password', 'autocomplete' => 'off']); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
