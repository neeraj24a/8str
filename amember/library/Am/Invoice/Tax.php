...
class Am_Invoice_Tax_Vat2015 extends Am_Invoice_Tax
{
    protected $rates = array(
        ...
        'LV'=>21, 'MT'=>18, 'NL'=>21, 'PL'=>23, 'PT'=>23, 'RO'=>20,
        'SE'=>25, 'SK'=>20, 'SI'=>22);
...
CUT
    ...
    public function getRate(Invoice $invoice, InvoiceItem $item = null)
    {
        ...
        //canary islands VAT 0%
        if($country == 'ES' && $u && in_array($u->get('state'), array('ES-PM', 'ES-SC')))
            return 0;
    ...
    function getRatePerProduct($country, InvoiceItem $item=null)
    {
        ...
        return (!is_null($customRate) ? $customRate : $this->getConfig('rate.'.$country, @$this->rates[$country]));
    }
