...
CUT
    ...
    function printLayoutHead($need_reset=true, $safe_jquery_load = false)
    {
        ...
        $t = "?" . crc32(filemtime(AM_APPLICATION_PATH . '/../library/Am/App.php'));
        if($need_reset) {
            $this->headLink()
        ...
        $hs->appendFile($this->_scriptJs('jquery/jquery.ui.js').$t);
        $hs->appendFile($this->_scriptJs('user.js').$t);
        $hs->appendFile($this->_scriptJs('upload.js').$t);
        $hs->appendFile($this->_scriptJs('magicselect.js').$t);
    ...
    function adminHeadInit()
    {
        ...
        $js_v = crc32(filemtime(AM_APPLICATION_PATH . '/../library/Am/App.php'));
        $t = "?" . $js_v;

        $this->headLink()->appendStylesheet($this->_scriptCss('reset.css').$t);
        $this->headLink()->appendStylesheet($this->_scriptJs("jquery/jquery.ui.css").$t);
        ...
        $this->headScript()
            ...
            ->prependFile($this->di->url("js.php?js=admin&v={$t}",false))
