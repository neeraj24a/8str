...
//              $this->addPostParameter('L_PAYMENTREQUEST_0_TAXAMT'.$i, $item->first_tax);
    ...
    {
        $form->addText("business", array('class' => 'am-el-wide'))
        ...
        $fs->addText("api_username", array('class' => 'am-el-wide', 'id' => 'paypal_api_username'))->setLabeL("API Username");
        $fs->addSecretText("api_password", array('id' => 'paypal_api_password'))->setLabel("API Password");
        $fs->addSecretText("api_signature", array('class' => 'am-el-wide', 'id' => 'paypal_api_signature'))->setLabel("API Signature");
        ...
        $form->addText("merchant_id", array('class' => 'am-el-wide paypal-business', 'id' => 'paypal_merchant_id'))
