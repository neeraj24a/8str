...
class AdminImportController extends Am_Mvc_Controller
{
    ...
    protected function addSub(Am_Record $user, $lineParsed)
    {
        ...
        $access->expire_date = $this->getImportField('expire_date', self::FIELD_TYPE_ACCESS)->getValue($lineParsed);
    ...
    protected function addImportFields()
    {
        ...
        $this->addImportField(new Import_Field('comment', ___('Comment')));
        ...
        $this->addImportField(new Import_Field_Date('expire_date', ___('Subscription Expire Date'), true), self::FIELD_TYPE_ACCESS);
    ...
    private function getForm($name, $recreate = false, $force_submited = false)
    {
