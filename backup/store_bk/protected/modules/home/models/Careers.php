...
class Careers extends BaseModel
{
	...
	public function rules()
	{
		...
		return array(
			array('id, first_name, last_name, email, mobile, date_entered, date_modified', 'required'),
                        array('cv', 'required','message' => 'Please Choose Your CV.'),
			...
			array('cv', 'length', 'max'=>512),
                        array('cv', 'file', 'types'=>'pdf, doc, docx', 'safe' => false),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, first_name, middle_name, last_name, email, mobile, cv, status, deleted, created_by, modified_by, date_entered, date_modified', 'safe', 'on'=>'search'),
		);
	}
