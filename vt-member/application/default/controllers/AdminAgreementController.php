...
class AdminAgreementController extends Am_Mvc_Controller
{
        ...
        function createGrid()
    {
        ...
        $grid = new Am_Grid_Editable('_agreement_editor', 'Agreements Editor', $ds, $this->_request, $this->view);
        return $grid;
    }
...
CUT;
    ...
    function advancedAction()
    {
        ...
        $grid->addField('url', ___('Document URL'), false)->setRenderFunction(function($rec) use ($grid){
            return $grid->renderTd(
                sprintf(
                    "<a href='%s' target='_blank'>text</a> | <a href='%s' target='_blank'>html</a>", 
