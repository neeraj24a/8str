...
class Am_Paysystem_Ccbill extends Am_Paysystem_Abstract
{
    ...
    public function _initSetupForm(Am_Form_Setup $form)
    {
        ...
        $form->addText('datalink_pass')->setLabel("DataLink Password\n" . 'read ccBill plugin readme (11) about');
        $form->addAdvCheckbox('dynamic_pricing')->setLabel('Allow Dynamic Pricing');
        $form->addText('salt')->setLabel("Salt\n" . 'Contact ccBill client support and receive the salt value, OR Create your own salt value (up to 32 alphanumeric characters) and provide it to ccBill client support.');
        $form->addText('flexform_id')->setLabel("ccBill FlexForm ID\n"
...
//            'prorate' => 1,
    ...
    function getReadme()
    {
         $ipn = $this->getDi()->url('payment/ccbill/ipn');
         $thanks = $this->getDi()->url('payment/ccbill/thanks').'&customVar1=%%customVar1%%&id=%%invoice%%';
        return <<<EOT
