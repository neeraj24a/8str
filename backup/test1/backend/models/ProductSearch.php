...
class ProductSearch extends Products
{
    ...
    {
        return [
            [['id', 'sku', 'slug', 'name', 'description', 'category', 'unit_price', 'offer_price', 'variation', 'size', 'colors', 'weight_type', 'weight', 'available', 'discount', 'main_image', 'is_featured', 'status', 'deleted', 'created_by', 'modified_by', 'date_entered', 'date_modified'], 'safe'],
