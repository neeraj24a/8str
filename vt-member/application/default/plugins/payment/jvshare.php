...
class Am_Paysystem_Jvshare extends Am_Paysystem_Abstract
{
    ...
    public function __construct(Am_Di $di, array $config)
    {
        ...
        $di->billingPlanTable->customFields()->add(
            new Am_CustomFieldText('jvshare_prod_item',
                "JVshare product ID"));
    }
    ...
    {
        return new Am_Paysystem_Transaction_JvshareThanks($this, $request, $response, $invokeArgs);
    }

    public function createTransaction(Am_Mvc_Request $request, Am_Mvc_Response $response, array $invokeArgs)
    {
        return new Am_Paysystem_Transaction_Jvshare($this, $request, $response, $invokeArgs);
    }
    ...
    public function getReadme()
    {
        ...
        return <<<CUT
<b>JVshare integration</b>
IPN URL for your products in JVshare should be set to:
<strong>$url</strong>
...
class Am_Paysystem_Transaction_Jvshare extends Am_Paysystem_Transaction_Incoming
{
    ...
    public function autoCreateGetProducts()
    {
        ...
        {
            if(($pl = Am_Di::getInstance()->billingPlanTable->findFirstByData('jvshare_prod_item', $p['productID'])) && ($p = $pl->getProduct()))
                $products[] = $p;
        }
        return $products;
    }
...
class Am_Paysystem_Transaction_JvshareThanks extends Am_Paysystem_Transaction_Incoming_Thanks
{
    public function getUniqId()
    {
        //
