					...
					<div class="row">
						<div class="col-md-4 col-sm-6 text-center text-md-left">
							<div class="inline-content medium">
								<p> <i class="fa fa-phone highlight rightpadding_5" aria-hidden="true"></i> 1833 DJ Promo </p>
								<p class="greylinks"> <i class="fa fa-envelope highlight rightpadding_5" aria-hidden="true"></i> <a href="mailto:support@8thwonderpromos.com">support@8thwonderpromos.com</a> </p>
							</div>
						</div>
						<div class="col-md-4 col-sm-6 text-center text-md-center"> <a class="social-icon socicon-facebook" href="#" title="Facebook"></a> <a class="social-icon socicon-twitter" href="#" title="Twitter"></a> <a class="social-icon socicon-google" href="#" title="Twitter"></a> <a class="social-icon socicon-linkedin"
				...
				<div class="container-fluid">
					<div class="row">
                        ...
                        <img src="http://pool.8thwonderpromos.com/images/logo.png" width="130" height="100" alt="">
							...
							<div class="header_right_buttons display_table_cell text-right hidden-xs"> <a href="https://www.8thwonderpromos.com/amember/login" class="theme_button color1">Sign In</a> </div>
						</div>
					</div>
				</div>
			</header>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h6 class="highlight">choose a membership plan below</h6>
					...
					<div class="row">
						<div class="col-md-12">
							<?php 
								$plans = [];
								$plans['yearly'] = ["title" => "Yearly","name"=>"Annual Membership","price" => "$199.99","message_1" => "Will Be Renewed Every Year","message_2" => "All Content Available For 1 Year","message_3" => "Maximum Store Discount","url" => "https://www.8thwonderpromos.com/amember/signup/yearly","position" => "third","is_scaled" => ""];
								$plans['monthly'] = ["title" => "Monthly","name"=>"Monthly Membership","price" => "$19.99","message_1" => "Will Be Renewed Every Month","message_2" => "All Content Available For 1 Month","message_3" => "Store Discount","url" => "https://www.8thwonderpromos.com/amember/signup/monthly","position" => "first","is_scaled" => "scale"];
								$plans['quaterly'] = ["title" => "Quaterly","name"=>"Quaterly Membership","price" => "$44.99","message_1" => "Will Be Renewed Every in 3 Month","message_2" => "All Content Available For 3 Month","message_3" => "Store Discount","url" => "https://www.8thwonderpromos.com/amember/signup/quaterly","position" => "second","is_scaled" => ""];
							?>
							<div class="promos">  
							    <?php foreach($plans as $plan): ?>
								<div class="promo <?php echo $plan['position']; ?> <?php echo $plan['is_scaled']; ?>">
								...
								<ul class="features">
									...
									<?php echo $plan['price']; ?>
									<br/>
									<?php if($plan['price'] == '$19.99'): ?>
	 							            <span style="font-size: 16px;font-weight: bold;position: relative;top: -16px;">($9.99 For First Month)</span>
								    	<?php endif; ?>
								    </li>
								    <li><?php echo $plan['message_1']; ?></li>
								    <li><?php echo $plan['message_2']; ?></li>
								    <li><?php echo $plan['message_3']; ?></li>
								    <li class="buy"><button onclick="window.location.replace('<?php echo $plan['url']; ?>')">Sign up</button></li>   
								</ul>
							    </div>
							    <?php endforeach; ?>
							</div>					
