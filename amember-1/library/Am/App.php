...
class Am_Config
{
    ...
    {
        try {
            $_ = Am_Di::getInstance()->db->selectCell(
...
class Am_App
{
    ...
    public function bootstrap()
    {
        ...
        // libs installed through composer
...
//            Zend_Translate::setCache($cache);
    ...
    public function initHooks()
    {
        ...
        $this->di->hook
            ...
            ->add(Am_Event::INVOICE_PAYMENT_REFUND, array('EmailTemplateTable', 'onInvoicePaymentRefund'))
