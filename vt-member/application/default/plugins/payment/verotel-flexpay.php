...
class Am_Paysystem_VerotelFlexpay extends Am_Paysystem_Abstract
{
    ...
    public function createTransaction(Am_Mvc_Request $request, Am_Mvc_Response $response, array $invokeArgs)
    {
        switch ($request->getParam('event', 'initial')) {
            case 'initial':
                return new Am_Paysystem_Transaction_VerotelFlexpayInitial($this, $request, $response, $invokeArgs);
            case 'credit':
                return new Am_Paysystem_Transaction_VerotelFlexpayCredit($this, $request, $response, $invokeArgs);
            case 'rebill':
                return new Am_Paysystem_Transaction_VerotelFlexpayRebill($this, $request, $response, $invokeArgs);
            case 'cancel':
                return new Am_Paysystem_Transaction_VerotelFlexpayCancel($this, $request, $response, $invokeArgs);
            default:
                return new Am_Paysystem_Transaction_VerotelFlexpayNull($this, $request, $response, $invokeArgs);
        }
    }
...
class Am_Paysystem_Transaction_VerotelFlexpay extends Am_Paysystem_Transaction_Incoming
{
...
class Am_Paysystem_Transaction_VerotelFlexpayInitial extends Am_Paysystem_Transaction_VerotelFlexpay
{
...
class Am_Paysystem_Transaction_VerotelFlexpayCredit extends Am_Paysystem_Transaction_VerotelFlexpay
{
    public function processValidated()
    {
...
class Am_Paysystem_Transaction_VerotelFlexpayRebill extends Am_Paysystem_Transaction_VerotelFlexpay
{
    public function processValidated()
    {
        $this->invoice->addPayment($this);
...
class Am_Paysystem_Transaction_VerotelFlexpayCancel extends Am_Paysystem_Transaction_VerotelFlexpay
{
    public function processValidated()
    {
...
class Am_Paysystem_Transaction_VerotelFlexpayNull extends Am_Paysystem_Transaction_VerotelFlexpay
{
    public function processValidated()
    {
        echo "OK";
