...
class Orders extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            [['id', 'customer', 'order_number', 'order_amount', 'payment_method', 'transaction_id', 'payment_status', 'order_date', 'freight', 'shipping_address', 'billing_address', 'created_by', 'modified_by', 'date_entered', 'date_modified'], 'required'],
