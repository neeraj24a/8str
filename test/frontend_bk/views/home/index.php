        ...
        <div class="grid grid--uniform grid--view-items">
			<section id="pricing-table">
				<div class="container">
					<div class="row">
						<div class="pricing">
							<div class="pull-left one-third small--one-whole">
								<div class="pricing-table">
									<div class="pricing-header">
										<p class="pricing-title">Monthly Bronze</p>
										<p class="pricing-rate"><sup>$</sup> 9.99* <span>1st Mo.</span></p>
										<p class="pricing-term">*For First Month then $19.99/Mo.</p>
										<a href="https://www.8thwonderpromos.com/amember/signup/monthly" target="_blank" class="btn btn-custom">Subscribe</a>
									</div>

									<div class="pricing-list">
										<ul>
											<li>
												No Discount On Membership
											</li>
											<li>
												<span>
													10% Off
											...
											<li>
												<span>No Free 8th T-Shirt</span>
											</li>
											<li><span>Unlimited</span> Downloads Audio & Video</li>
							...
							<div class="pull-left one-third small--one-whole">
								<div class="pricing-table">
									<div class="pricing-header">
										<p class="pricing-title">Annual Platinum</p>
										<p class="pricing-rate"><sup>$</sup> 174.99 <span>/Yr.</span></p>
										<a href="https://www.8thwonderpromos.com/amember/signup" target="_blank" class="btn btn-custom">Subscribe</a>
									</div>

									<div class="pricing-list">
										<ul>
											<li>
												<span>25% Off</span> On Membership
											</li>
											<li>
												<span>
													30% Off
							...
							<div class="pull-left one-third small--one-whole">
								<div class="pricing-table">
									<div class="pricing-header">
										<p class="pricing-title">Quaterly Gold</p>
										<p class="pricing-rate"><sup>$</sup> 54.99 <span>/3 Mo.</span></p>
										<a href="https://www.8thwonderpromos.com/amember/signup" target="_blank" class="btn btn-custom">Subscribe</a>
									</div>
									...
									<div class="pricing-list">
										<ul>
											<li>
												<span>10% Off</span> On Membership
											</li>
											<li>
												<span>
													20% Off
