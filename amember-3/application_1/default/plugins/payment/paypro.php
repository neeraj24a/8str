...
class Am_Paysystem_Paypro extends Am_Paysystem_Abstract
{
    ...
    public function _initSetupForm(Am_Form_Setup $form)
    {
        ...
        $form->addText('key', array('size' => 20, 'rel' => 'protocol-old'))
            ->setLabel('PayPro Product Variable Price Hash');
        $form->addText('enc_key', array('class' => 'el-wide', 'rel' => 'protocol-new'))
            ->setLabel("Encryption key\n" .
                "Key must be length 32 symbols");
        $form->addText('enc_vector', array('class' => 'el-wide', 'rel' => 'protocol-new'))
