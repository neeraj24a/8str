...
class Am_Paysystem_Flexpay extends Am_Paysystem_Abstract
{
    ...
    public function _initSetupForm(Am_Form_Setup $form)
    {
        $form->addAdvRadio('brand')
            ...
            ->loadOptions(array(
                ...
                'FreenomPay' => 'FreenomPay'
            ));
        $form->addText('shop_id')
            ->setLabel('Shop Id');
        $form->addText('signature_key', array('class' => 'el-wide'))
    ...
    {
        switch ($this->getConfig('brand')) {
            case 'Verotel':
                return 'https://secure.verotel.com/startorder';
            case 'CardBilling':
                return 'https://secure.billing.creditcard/startorder';
            case 'FreenomPay':
                return 'https://secure.freenompay.com/startorder';
        }
    }
