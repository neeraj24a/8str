         ...
         <div class="grid grid--no-gutters">
            <div class="grid__item medium-up--one-half">
               <ul class="site-footer__linklist">
                  ...
                  <li class="site-footer__linklist-item">
                     <a href="<?php echo Url::toRoute('/shop'); ?>">SHOP</a>
                  </li>
                  <li class="site-footer__linklist-item">
                     <a href="https://pool.8thwonderpromos.com/contact-us">CONTACT US</a>
                  </li>
               </ul>
            </div>
         ...
         <div class="grid grid--no-gutters">
            <div class="grid__item medium-up--one-half">
               <ul class="list--inline site-footer__social-icons social-icons">
                  <li>
                     <a class="social-icons__link" href="http://instagram.com/8thwonderpromos" title="8thwonderpromos on Instagram">
