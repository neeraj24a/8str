...
<input type="text" name="%s[d]" id="%s-d" class="datepicker input_datetime-date" value="%s" size="8" />
<input type="text" name="%s[t]" id="%s-t" class="input_datetime-time" value="%s" size="5" placeholder="HH:mm" />
</div>
CUT
