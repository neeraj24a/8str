...
class Am_Form_Admin_Product extends Am_Form_Admin
{
    ...
    function addBillingPlans()
    {
        ...
        foreach ($plans as $plan) {
            ...
            $html .= "    <li data-plan_id='{$plan['plan_id']}'><a href='#$id'><span>$title</span></a><a href='javascript:;' class='billing-plan-del' title='Delete Billing Plan'>&#10005;</a></li>\n";
        }
        ...
        foreach ($plans as $plan) {
            $id = 'plan-'.$plan['plan_id'];
            //$this->addRaw()->setContent("<div id='$id'>\n");
...
CUT
    ...
    function init()
    {
        ...
        $fieldSet->addTextarea('comment', array('class' => 'el-wide'))
