...
CUT
        ...
        $fieldSet->addTextarea('comment', array('class' => 'el-wide', 'id' => 'comment'))
...
CUT
    ...
    public function disableAutoLockAction()
    {
        ...
        $this->_response->redirectLocation($b);
    }
    ...
    public function notConfirmedAction()
    {
        ...
        $grid->addField('expires', ___('Expires'))
            ->setRenderFunction(function($r, $fn, $g, $fo) {
                ...
                return $g->renderTd(sprintf('%s <span style="margin-left:1em; color:#c2c2c2">%s</span>',
...
//        {
//            $this->_response->redirectLocation($this->getView()->userUrl($record->pk()));
//            exit();
//        }
    }
    ...
    function loginAsAction()
    {
        ...
        $this->_response->redirectLocation($this->getUrl('member', "index", null));
    }
