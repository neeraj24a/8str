...
class Am_Paysystem_FastspringContextual extends Am_Paysystem_Abstract
{
    ...
    function _initSetupForm(\Am_Form_Setup $form)
    {
        ...
        $form
            ->addPassword('api_password', 'class="el-wide"')
...
<b>FastSpring plugin installation</b>
 ...
 2. Configure FastSpring Product Path  at aMember CP -> Manage Products -> ->Billing Plans


 4. Configure Webhook URL  in your FastSpring account (Integrations -> Webhooks)
