...
class Am_Paysystem_CheckoutCom extends Am_Paysystem_CreditCard
{
    ...
    public function getCheckoutJs()
    {
        return $this->getConfig('testing') ?
            'https://sandbox.checkout.com/js/v1/checkout.js' :
    ...
    {
        return $this->getConfig('testing') ?
            'https://sandbox.checkout.com/js/v1/checkoutkit.js' :
    ...
    public function _doBill(Invoice $invoice, $doFirst, CcRecord $cc, Am_Paysystem_Result $result)
    {
        ...
        $data = array_merge($data, array(
            ...
            'transactionIndicator' => $doFirst ? 1 : 2,
...
CUT
    ...
    {
        if ($this->getInvokeArg('hosted') ||
            !($token = $this->getRequest()->get('cko-card-token'))) {
