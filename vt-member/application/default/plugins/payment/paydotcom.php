...
class Am_Paysystem_Paytodcom extends Am_Paysystem_Abstract
{
    const PLUGIN_STATUS = self::STATUS_BETA;
    const PLUGIN_REVISION = '5.5.1';

    public $domain = "";
    protected $defaultTitle = "Paytodcom";
    ...
    public function __construct(Am_Di $di, array $config)
    {
        ...
        $di->billingPlanTable->customFields()->add(
            new Am_CustomFieldText('paytodcom_prod_item',
                "Paytodcom product ID"));
    }
    ...
    {
        return new Am_Paysystem_Transaction_PaytodcomThanks($this, $request, $response, $invokeArgs);
    }

    public function createTransaction(Am_Mvc_Request $request, Am_Mvc_Response $response, array $invokeArgs)
    {
        return new Am_Paysystem_Transaction_Paytodcom($this, $request, $response, $invokeArgs);
    }
    ...
    public function getReadme()
    {
        ...
        return <<<CUT
<b>Paytodcom integration</b>
IPN URL for your products in Paytodcom should be set to:
<strong>$url</strong>
...
class Am_Paysystem_Transaction_Paytodcom extends Am_Paysystem_Transaction_Incoming
{
    ...
    public function autoCreateGetProducts()
    {
        ...
        {
            if(($pl = Am_Di::getInstance()->billingPlanTable->findFirstByData('paytodcom_prod_item', $p['productID'])) && ($p = $pl->getProduct()))
                $products[] = $p;
        }
        return $products;
    }
...
class Am_Paysystem_Transaction_PaytodcomThanks extends Am_Paysystem_Transaction_Incoming_Thanks
{
    public function getUniqId()
    {
        //
