...
function showHideMaxmind()
{
    ...
    jQuery("[id^=maxmind_]").closest(".am-row").toggle(el.prop('checked'));
    if(el.prop('checked'))
...
/*function showHideNumberidentification()
{
    ...
    jQuery("[id^=maxmind_tni_phone_types-]").closest(".am-row").toggle(el.prop('checked'));
    jQuery("[id^=maxmind_use_number_identification-]").closest(".am-row").toggle(el.prop('checked'));
    if(el.prop('checked'))
        showHidePhonetypes();
}*/
function showHidePhonetypes()
{
    jQuery("[id^=maxmind_tni_phone_types-]").closest(".am-row").toggle(jQuery("[id^=maxmind_use_number_identification-]").prop('checked'));
}
jQuery(function(){
